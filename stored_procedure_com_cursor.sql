...
*/
	...
	*/
	...
	-- Deve ser salvo no diretório autorizado pelo server 
	-- para saber qual o diretório que pode salvar execute o seguinte comando.
	-- SHOW VARIABLES LIKE "secure_file_priv";

	REMOVE OUTFILE "C:\\ProgramData\\MySQL\\MySQL Server 5.7\\Uploads\\LISTA_PRODUTOS_TEMP.CSV"; 
	SELECT * FROM LISTA_PRODUTOS_TEMP INTO OUTFILE 'C:\\ProgramData\\MySQL\\MySQL Server 5.7\\Uploads\\LISTA_PRODUTOS_TEMP.CSV'  
